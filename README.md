...
| 2  | - **Nombre:** Mauricio Elera <br> - **Edad:** 25 años | Mauricio administra el inventario de un negocio en crecimiento y percibe que StockTrack le brinda una experiencia profesional y confiable gracias a su diseño ordenado y fácil de navegar. Destaca que las métricas rápidas y las alertas inteligentes le permiten reaccionar a tiempo ante riesgos como el bajo stock o productos por vencer. Considera muy intuitivo el proceso para registrar productos y gestionar roles de personal. Aunque está satisfecho con la estructura general del sistema, señala que un módulo de facturación y la integración con software contable harían la plataforma mucho más completa. Para él, la mayor ventaja de StockTrack es centralizar toda la operación en un solo lugar, lo que le ayuda a reducir errores y mantener una gestión mucho más eficiente. | ![Entrevista 2 - Dueños de bodegas](./assets/Chapter-V/entrevista-Mauricio-Elera.png) | 
| 3  | - **Nombre:** Mariana Torres <br> - **Edad:** 29 años | Camila dirige un pequeño negocio y valoró desde el inicio el aspecto profesional y la facilidad de uso de StockTrack, especialmente la claridad del menú lateral y el registro guiado de productos y proveedores. Afirma que las métricas del dashboard y los reportes gráficos le facilitan evaluar rápidamente el estado de su inventario y tomar decisiones informadas. Considera especialmente útiles las alertas de vencimiento y de bajo stock, ya que le permiten anticiparse a problemas operativos. Aunque la plataforma cumple con sus expectativas, menciona que sería ideal añadir herramientas como automatización de pedidos y mayor personalización del dashboard. Para Camila, la principal fortaleza de StockTrack es la organización y centralización de todas las funciones esenciales en una sola aplicación. | ![Entrevista 3 - Dueños de bodegas](./assets/Chapter-V/entrevista-Mariana-Torres.png) | 
